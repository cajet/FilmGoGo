...
public class MovieAdapter extends BaseAdapter {
    ...
    public MovieAdapter (LayoutInflater inflater, List<HashMap<String, Object>> data) {
        mInflater = inflater;
        mData = data;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        view = mInflater.inflate(R.layout.item_movie, viewGroup, false);
        ...
        if (!mData.get(i).get("score").toString().equals("0")) {
            ...
            movie_score.setTextColor(0xffffb400);
            movie_score.setTextSize(15);
        } else {
            movie_score.setText("暂无评分");
            movie_score.setTextColor(0xff999999);
            movie_score.setTextSize(12);
        }
